    ...
    public class PeliculasController : Controller
    {
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var pelicula = await _context.Peliculas
                .FirstOrDefaultAsync(m => m.IdPel == id);
            if (pelicula == null)
            {
                return NotFound();
            }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdPel,Nombre,Descripcion,Director,Genero,Imagen")] Pelicula pelicula)
        {
            if (id != pelicula.IdPel)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!PeliculaExists(pelicula.IdPel))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
          return (_context.Peliculas?.Any(e => e.IdPel == id)).GetValueOrDefault();
        }
    }
}
